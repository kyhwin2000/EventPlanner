...
//Rare exceptions to indicate a bug in the _eventplanner code (Eg, function that a subclass should have implemented)
...
/**
 The base class for EventPlanner proxies.
 */
