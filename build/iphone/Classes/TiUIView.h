...
/**
 Base class for all EventPlanner views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the EventPlanner view hierarchy (such as wrapped iOS UIViews) was touched.
