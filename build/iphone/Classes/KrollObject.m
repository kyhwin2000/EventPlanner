 ...
 * Copyright (c) 2009-2011 by EventPlanner, Inc. All Rights Reserved.
...
//@interface EventPlannerObject : NSObject
//@end

@interface EventPlannerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[EventPlannerObject class]])
		{
			for (NSString *key in [[(EventPlannerObject*)o modules] allKeys])
			{
