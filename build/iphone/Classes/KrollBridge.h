...
@interface EventPlannerObject : KrollCoverageObject {
#else
@interface EventPlannerObject : KrollObject {
#endif
@private
...
extern NSString * EventPlanner$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	EventPlannerObject *_eventplanner;
    KrollObject* console;
	BOOL shutdown;
