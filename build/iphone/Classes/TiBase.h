...
// in simulator we redefine to format for EventPlanner Developer console
...
{\
	NSString * exceptionName = [@"org.eventplanner." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.eventplanner";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIEventPlannerNativeItemNone = -1, 
	UIEventPlannerNativeItemSpinner = -2,
	UIEventPlannerNativeItemProgressBar = -3,
	
	UIEventPlannerNativeItemSlider = -4,
	UIEventPlannerNativeItemSwitch = -5,
	UIEventPlannerNativeItemMultiButton = -6,
	UIEventPlannerNativeItemSegmented = -7,
	
	UIEventPlannerNativeItemTextView = -8,
	UIEventPlannerNativeItemTextField = -9,
	UIEventPlannerNativeItemSearchBar = -10,
	
	UIEventPlannerNativeItemPicker = -11,
	UIEventPlannerNativeItemDatePicker = -12,
	
	UIEventPlannerNativeItemInfoLight = -13,
	UIEventPlannerNativeItemInfoDark = -14,
	
	UIEventPlannerNativeItemDisclosure = -15,
	
	UIEventPlannerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all EventPlanner instances of
